class Course {
  ...
  static List<Course> generateCourses(int id) {
    switch (id) {
      ...
      case 3:
        return [
          Course('鯨魚擱淺(一)', 'assets/icons/picture.png', '回家路上擱淺岸邊的鯨魚', 'assets/images/task_carousel_turtle_1.jpg'),
          Course('鯨魚擱淺(二)', 'assets/icons/picture.png', '描述...', 'assets/images/task_carousel_turtle_2.jpg'),
          Course('鯨魚擱淺(三)', 'assets/icons/picture.png', '描述...', 'assets/images/task_carousel_turtle_3.jpg'),
        ];
      default:
        return [
